...
The V1.0.0 release-candidate acceptance checklist and cutover runbook remain blocked by final readiness and explicit cutover authorization. Do not create a V1.0.0 release-candidate branch, release tag, cutover claim, or readiness claim until the release checklist and cutover runbook pass after G61 closeout, a final readiness pass is recorded, and explicit cutover authorization is recorded.
