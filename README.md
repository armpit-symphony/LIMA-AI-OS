...
The V1.0.0 release-candidate acceptance checklist is satisfied for first-consumer harness testing; the cutover runbook remains blocked by explicit operator authorization. Do not create a V1.0.0 release-candidate branch, release tag, cutover claim, or readiness claim until explicit cutover authorization is recorded and the runbook confirms checklist/reconciliation evidence remains current.
