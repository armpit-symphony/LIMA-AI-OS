...
The next smallest safe V1 action is to run the final readiness audit after the release checklist refresh, then require explicit cutover authorization before any branch, tag, cutover, or readiness claim.
