...
Phase 4.14 is the first explicitly approved test-only harness implementation phase. It must stay under `tests/`, remain deterministic and synthetic-only, and must not move runtime behavior into `lima/`.
