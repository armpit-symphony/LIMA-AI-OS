...
`docs/V1_READINESS_GAP_MATRIX.md` records the current V1 gap order. The next smallest safe gap is Sparkbot_shell source-backed `thinking` / progress-state proof before runtime implementation.
