...
Decision packet status: `approved_for_v1_g37_implementation`
...
- Approved next implementation branch: `v1-g37-consumer-integration-patch-preview`.
- Current next action: implement only the approved V1-G37 consumer integration patch-preview evidence slice.
