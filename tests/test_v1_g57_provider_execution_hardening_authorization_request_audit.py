...
def test_v1_g57_request_audit_status_docs_match_current_gate() -> None:
    ...
    assert "V1-G57 implementation approval recorded: no." in state
    assert "No V1-G57 implementation is approved" in target
    assert "Current active gate: `V1-G57`" in gap
