"""Static checks for the V1-G47 consumer fake-executor smoke request."""
...
FIXTURE_PATH = (
    ...
    / "fixtures"
    / "runtime_extraction"
    / "v1_g47_consumer_fake_executor_provider_model_call_smoke_approval_request.json"
)
...
def test_v1_g47_request_docs_and_fixture_exist() -> None:
    fixture = _load_fixture()

    assert fixture["gate_id"] == (
        "v1_g47_consumer_fake_executor_provider_model_call_smoke_approval_request"
    )
    assert fixture["api_status"] == "CANDIDATE_ONLY"
    assert fixture["branch"] == (
        "prepare-v1-g47-consumer-fake-executor-provider-model-call-smoke-approval-request"
    )
...
def test_v1_g47_has_no_implementation_approval_yet() -> None:
    fixture = _load_fixture()
    decision = fixture["decision_record"]

    assert fixture["implementation_approved"] is False
    assert fixture["operator_approval_recorded"] is False
    assert fixture["consumer_fake_executor_provider_model_call_smoke_approved"] is False
    assert fixture["consumer_fake_executor_provider_model_call_smoke_added"] is False
...
def test_v1_g47_exact_decision_options_are_locked() -> None:
    fixture = _load_fixture()
    ...
    assert fixture["required_approval_wording"].startswith(
        "I explicitly approve V1-G47 implementation"
    )
...
def test_v1_g47_consumer_smoke_target_is_exact() -> None:
...
def test_v1_g47_approved_file_scope_if_approved_is_exact() -> None:
    fixture = _load_fixture()
...
def test_v1_g47_prior_evidence_refs_exist() -> None:
    fixture = _load_fixture()
...
def test_v1_g47_forbidden_boundaries_remain_false_in_request() -> None:
    fixture = _load_fixture()
...
def test_v1_g47_docs_contain_consumer_boundary_language() -> None:
    fixture = _load_fixture()
    ...
    assert "Recorded choice: Approve-V1-G47" in decision_text
    assert "Implementation must not start until `Approve-V1-G47`" in preflight_text
